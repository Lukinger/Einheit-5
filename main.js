...
map.on('singleclick', function(e) {
  ...
  if (markup) {
    ...
    window.location.href = 'https://student.ifip.tuwien.ac.at/geoweb/2017/g01/feedback.php?pos=' +
      pos.join(' ');
  }
});
  ...
  if (source instanceof VectorSource) {
    source.once('change', function() {
      ...
      if (Object.keys(loadedSources).length == 2) {
        var feedbacks = loadedSources['https://student.ifip.tuwien.ac.at/geoweb/2017/g01/map/postgis_geojson.php'].getFeatures();
...
map.getLayers().on('add', function(e) {
  ...
  if (source instanceof VectorSource) {
    source.once('change', function() {
      ...
      if (Object.keys(loadedSources).length == 2) {
        var feedbacks =
          loadedSources['https://student.ifip.tuwien.ac.at/geoweb/2017/g01/map/postgis_geojson.php'].getFeatures();
        var bezirke =
